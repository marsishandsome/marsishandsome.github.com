...
1. 如果用户在类里面定义了writeObject方法，Java会优先选择这个方法来序列化该类。

2. 所以Java会首先通过反射的机制检查类中有没有writeObject方法
```
...
3. 在检查有没有writeObject方法的时候，调用了getDeclaredMethod获取所以的方法
```
...
4. getDeclaredMethod中调用了privateGetDeclaredMethods
```
